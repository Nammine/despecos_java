		  ...
		  <tr>
		    <td background="images/dh_bg.gif" align="left" height="12">
		      <table width="100" border="0" cellspacing="0" cellpadding="0" align="center">
		        <tr>
		          <td width="5%">　</td>
		          <td width="10%"><a href="bookServlet" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/index_on.gif',1)">
		          ...
		          <td width="10%"><a href="listOrderFormServlet" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','images/order_on.gif',1)">
...
<c:forEach items="${sessionScope.cart.orderLines }" var="orderLine">         
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp?productid=2">${orderLine.bookName }</a></td>
			<td class=tablebody2 valign=middle align=center width="">${orderLine.bookPrice }</td>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle align=left width="">&nbsp;&nbsp;<font color="#ff0000"><b>￥${sessionScope.cart.cost }</b></font></td>
			<td class=tablebody1 valign=middle align=center width="">　</td>
		</tr>
		<tr>
			<td class=tablebody2 valign=middle align=center colspan="6"><input type="button" value="提交订单" onclick="javascript:window.location='submitOrderServlet';"> <input type="button" value="继续购物" onclick="javascript:window.location='bookServlet';"> <input type="button" value="清空购物车" onclick="javascript:window.location='removeAllProduct.action';"></td>
		</tr>
                </table><br>
<!--文件尾开始-->
