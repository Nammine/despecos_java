...
<!--文件体开始-->
		...
		<tr>
			<td valign=middle align=center height=25 background="images/bg2.gif" colspan="2"><p><font color="#ffffff"><b>${requestScope.book.name }</b></font></td>
		</tr>
		<tr>
			<td class=tablebody1 valign=middle align=center width="20%">【
			I&nbsp; D 】</td>
			<td class=tablebody1 valign=middle width="80%">&nbsp;&nbsp;${requestScope.book.id }</td>
		</tr>
		<tr>
			<td class=tablebody1 valign=middle align=center width="20%">【
			价&nbsp; 格 】</td>
		...
		<tr>
			<td class=tablebody1 valign=middle align=center width="">【详情】</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;${requestScope.book.description }</td>
		</tr>
		<tr>
