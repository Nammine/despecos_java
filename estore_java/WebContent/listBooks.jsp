...
<!--文件体开始-->
		...
		<td height=25 valign=middle>
                  ...
                  <a href=index.jsp>杰普电子商务门户</a> →
					...
					index.jsp>欢迎<font color="red"></font>光临！
                </td>
                </tr>
		</table>
              <br>
 ...
 <c:forEach items="${sessionScope.books }" var="book">         
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="bookDetail?bookId=${book.id }">${book.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">${book.price }</td>
			<td class=tablebody1 valign=middle align=center width="">
			<a href="addToCart?bookId=${book.id }"><img border="0" src="images/car_new.gif" width="97" height="18"></a> </td>
		</tr>
</c:forEach>                     
